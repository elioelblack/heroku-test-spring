...
import com.encuesta.validators.RolValidator;
...
public class RolController {
	...
	public ResponseEntity<?> show(@PathVariable(name = "id") Integer id)
			throws Exception {		
		Optional<Rol> model = rolRepository.findById(id);		
		if (!model.isPresent()) {            
			return notFound();
        }
	...
	public ResponseEntity<?> create(
			@RequestBody Rol model) throws Exception {
		...
		model = rolRepository.save(model);
	...
	public ResponseEntity<?> update(			
			...
			@RequestBody Rol model)
			throws Exception {
		
		Optional<Rol> optionalFromDataBase =  
		...
		Rol modelFromDatabase = optionalFromDataBase.get();
		...
		model =  rolRepository.save(modelFromDatabase);
	...
	public ResponseEntity<?> delete(@PathVariable Integer id) {
		Optional<Rol> workgruoup = rolRepository.findById(id);
		if (workgruoup != null) {
	...
	private Errors validate(Rol model) throws Exception {
